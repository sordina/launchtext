...
"d" [[3 2] [3 3] [2 3] [3 4] [3 5] [1 3] [3 6] [2 6] [0 4] [0 5] [1 6] [3 1]]
...
"k" [[2 3] [0 1] [0 2] [2 5] [3 6] [0 3] [1 4] [0 4] [0 5] [0 6] ]
"L" [[0 1] [0 2] [3 6] [0 3] [2 6] [0 4] [0 5] [1 6] [0 6] ]
"l" [[0 2] [0 3] [2 6] [0 4] [0 5] [1 6] ]
...
"n" [[3 3] [3 4] [3 5] [2 5] [3 6] [0 3] [1 4] [0 4] [0 5] [0 6] ]
...
"S" [[2 1] [1 1] [2 4] [3 5] [0 2] [3 6] [0 3] [1 4] [2 6] [1 6] [0 6] [3 1]]
"s" [[3 2] [2 2] [1 2] [2 4] [3 5] [0 3] [1 4] [2 6] [1 6] [0 6] ]
"T" [[2 1] [1 1] [0 1] [1 2] [1 3] [1 4] [1 5] [1 6] [3 1]]
"t" [[3 3] [2 3] [1 2] [1 3] [0 3] [1 4] [2 6] [1 5] ]
...
(defn-match fst ([x & xs] x))

(def max-fst [bits] (apply max (map fst bits)))

(defn-match width ([c bits] [c [(max-fst bits) bits]]))

(def letterslen (apply hash-map (map width letters)))

(defn-match letter ([len bits]
                    (map (apply hash-map bits)
                         (range 0 (pred len)))))

; Returns an array of [Column, [Row]]
(defn blit [text]
  (let [bitmaps (apply hash-map (map letterslen text))
        length  (reduce + (map fst bitmaps))
        result  (mapcat letter bitmaps)
       ]
       [length result]))
