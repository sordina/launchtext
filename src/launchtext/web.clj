...
(def html "<!DOCTYPE HTML>\n <html> <head> <meta http-equiv='content-type' content='text/html; charset=utf-8'> <title>Launchpad Message</title> </head> <body> <h1>Launchpad Message</h1> <p> Source available <a href='https://github.com/sordina/launchtext'>on Github</a> </p> <form action='/' method='post'> <p><input type='text' name='message'></p> <p><input type='submit' value='Post!'></p> </form> </body> </html>")
